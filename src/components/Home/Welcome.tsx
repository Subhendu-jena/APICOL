          ...
          <SlideInFromLeft className=" animate-slide-in-left p-5   ">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed text-justify">
              <p>
                ...
                <strong>01-06-1996</strong> with the sole objective of promoting
                agro-based industries/food processing industries including
                commercial agriculture/horticulture/animal husbandry/fisheries.
              </p>
              <p>
