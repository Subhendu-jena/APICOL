...
const PhotosGallery: React.FC = () => {
  ...
  const tabs = [
    { key: "photo", label: "Mukhyamantri Krushi Udyog Yojana (MKUY)" },
    { key: "video", label: "Financial Assistance to Cold Storages (FACS)" },
    { key: "social", label: "Agri entrepreneurship Promotion Scheme (AEPS)" },
  ];
